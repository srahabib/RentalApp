...
<div class=" flex items-center justify-center ">
  <div class="px-10">
    <div class="bg-white w-full rounded-2xl px-5 py-8 transition duration-500">
      {/* <div class="w-14 h-14 bg-amber-600 rounded-full flex items-center justify-center font-bold text-white">LOGO</div> */}
      <div class="mt-4">
        <h1 class="text-lg text-gray-700 font-semibold hover:underline cursor-pointer">Property Review</h1>
        <div class="flex mt-2">
