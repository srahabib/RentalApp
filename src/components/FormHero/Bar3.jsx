    ...
    return (
        <div className="container">
            <ol class="mx-56 mb-10 pt-10 flex content-center items-center ">
                <li
                    class="flex w-full items-center text-white  dark:text-orange-500 after:content-[''] after:w-full after:h-1 after:border-b
                ...
                <li class="flex w-full items-center after:content-[''] text-white after:w-full after:h-1 after:border-b after:border-grey1 after:border-4 after:inline-block dark:after:border-green2">
                ...
                <li className="flex items-center">
                    <span
                        class="flex items-center text-white justify-center w-10 h-10 bg-green2
                    rounded-full lg:h-12 lg:w-12 dark:bg-gray-700 shrink-0"
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
