...
const Login = () => {
    ...
    return (
        <div className="bg-[#F9FAFB] flex items-center py-20">
            <div className="h-max mx-auto flex flex-col items-center">
                <img className="h-[47px] w-[47px] mb-5" src="/images/RentorLogo2 Black.png" alt="" />
                ...
                <form onSubmit={handleSubmit} className="bg-white shadow-xl p-10 flex flex-col gap-4 text-sm">
                    ...
                    <div>
                        <button className="bg-green2 w-full py-2 rounded-md text-white font-bold cursor-pointer hover:bg-grey1 focus:ring-4 focus:outline-none focus:ring-grey1 focus:bg-bej1 focus:text-black" type="submit">Login</button>
                    </div>
                    <div className="flex">
