    ...
    return (
        ...
        <main>
            ...
            :bg-gray-500 shadow-xl ">
                ...
                <div class="bg-green2 shadow-lg pb-3 rounded-b-2xl">
                    <div
                        ...
                        <div class="felx mx-auto pt-10 w-100  ">
                            ...
                            {/* <!--social--> */}
                            <a href=""> <button
                                class="p-2 shadow-lg ml-10 tr-300 w-100 font-medium bg-green2 text-white rounded hover:bg-grey1 focus:outline-none focus:bg-bej1 focus:text-black">Edit profile</button></a>


                        </div>
                    </div>

                    <div class="grid px-2 py-2 bg-green1 items-center justify-around grid-cols-3 gap-4 divide-x divide-solid ">
