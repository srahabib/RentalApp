...
after:border-green-100 after:border-4 after:inline-block ">
                    <span class="flex items-center justify-center w-10 h-10 bg-green1 rounded-full lg:h-12 lg:w-12  shrink-0">
     ...
     rounded-full lg:h-12 lg:w-12  shrink-0">
            ...
            <div className="container mx-auto p-4">
                <div className="bg-white dark:bg-gray-700 shadow rounded-lg p-6">
                    <h1 className="text-xl font-semibold mb-4 text- dark:text-gray-100">Category</h1>
            ...
            <div className="container mx-auto p-4">
                <div className="bg-white dark:bg-gray-700 shadow rounded-lg p-6">
                    ...
                    <button onClick={handleClick} type="button" id="theme-toggle" class="px-5 mt-10 text-center justify-items-end py-2 rounded bg-green2 text-white font-bold hover:bg-grey1 focus:ring-4 focus:outline-none focus:ring-grey1 focus:bg-bej1 focus:text-black transition-colors">
                        Next
                    </button>
                </div>
            </div>
