      ...
      <form action="#" class="mx-auto max-w-screen-xl px-4 2xl:px-0">
        ...
        <div class="mt-6 sm:mt-8 lg:flex lg:items-start lg:gap-12 xl:gap-16">
          ...
          <div class="mt-6 w-full space-y-6 sm:mt-8 lg:mt-0 lg:max-w-xs xl:max-w-md">
            <div class="flow-root">
              <div class="-my-3 divide-y divide-gray-200 dark:divide-gray-800">
                ...
                <dl class="flex items-center justify-between gap-4 py-3">
                  ...
                  <dd class="text-base font-medium text-grey1">-0</dd>
                </dl>
            ...
            <a className='inline-block px-4 py-2 bg-green2 text-white rounded hover:bg-grey1 focus:ring-4 focus:outline-none focus:ring-grey1 focus:bg-bej1 focus:text-black cursor-pointer' onClick={handleProceedToPayment} >Proceed to payment</a>


            <div class="space-y-3">
              {/* <button type="submit" class="flex w-full items-center justify-center rounded-lg bg-green1 px-5 py-2.5 text-sm font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4  focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Proceed to Payment</button> */}
