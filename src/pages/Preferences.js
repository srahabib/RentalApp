                ...
                <aside className="w-full md:w-1/4 mt-5 ml-5 bg-white text-green2 p-4">
                    <nav>
                        <ul className="space-y-4">
                            ...
                            <li>
                                <Link href="/Preferences" className=" py-2 flex  px-4 rounded hover:bg-gray-100 font-bold">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                        viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 mr-3  hover:text-green2">
