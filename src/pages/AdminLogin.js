...
const AdminLogin = () => {
  ...
  async function handleSubmit(event) {
    ...
    const response = await fetch(
      "https://rentor-b.onrender.com/auth/admin/login",
      {
        method: "POST",
    ...
    <div className="bg-[#F9FAFB] flex items-center py-10">
      <div className="h-max mx-auto flex flex-col items-center">
        ...
        >
          ...
          <div>
            <button
              className="bg-green1 w-full py-2 rounded-md text-white font-bold cursor-pointer hover:bg-bg-green2 hover:bg-grey1 focus:ring-4 focus:outline-none focus:ring-grey1 focus:bg-bej1 focus:text-black"
              type="submit"
            >
              Login
            </button>
          ...
          {/* <div className="flex">
            ...
            <p className="text-center font-bold text-blue pl-1">
              {" "}
