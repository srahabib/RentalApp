...
const Membership = () => {
    return (
        <main>
            <div class="bg-gray-100 dark:bg-gray-800 transition-colors duration-300 py-10">
                <div class="container mx-auto p-4">
                    ...
                    <div class="flex  w-auto  mb-5 mt-5 items-center border-l-8 border-green2 bg-white p-4 text-gray-900 shadow-lg">
                        <div class="min-w-0">
